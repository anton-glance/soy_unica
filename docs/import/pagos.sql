...
-- feb 26 fila 4 · julieta yahaira rdz · merry -yana, mantilla 039
INSERT INTO customers (store_id, name, apellido, source, notes)
  VALUES ('mty', 'julieta', 'yahaira rdz', 'pagos.xlsx', 'feb 26 fila 4');
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0016', last_insert_rowid(), u.id, 'active',
         '2026-02-11', 'Histórico (importado)', 3825000, 0, 3825000, 1,
         'pagos.xlsx · feb 26 · fila 4'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0016'), NULL, 'merry -yana', 3825000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0016'), 13, 'mantilla 039', 0, 'accessory', 1);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
  SELECT c.id, 'mty', '2026-02-11', 'anticipo', 765000, 'cash', c.seller_id, 1
    FROM contracts c WHERE c.folio = 'MTY-IMP-0016';
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
  SELECT c.id, 'mty', '2026-03-11', '6650 11 maz', 665000, 'cash', c.seller_id, 1
    FROM contracts c WHERE c.folio = 'MTY-IMP-0016';
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0017', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0017'), NULL, 'p47 de liquidacion', 1620000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0017'), NULL, 'crinolina 6 aros', 0, 'accessory', 1);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0018', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0018'), 10, 'madelyn', 2440000, 'dress', 0);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0019', last_insert_rowid(), u.id, 'active',
         '2026-02-11', 'Histórico (importado)', 3825000, 0, 3825000, 1,
         'pagos.xlsx · feb 26 · fila 15'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0019'), NULL, 'merry- yana liquidacion', 3825000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0020', last_insert_rowid(), u.id, 'paid',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0020'), NULL, 'melissa', 2100000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0020'), 13, 'mantilla 039', 0, 'accessory', 1);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0021', last_insert_rowid(), u.id, 'paid',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0021'), NULL, 'azalia m', 3990000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0021'), NULL, 'crinolina 6a', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0021'), NULL, 'liga', 0, 'accessory', 2);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0021'), NULL, 'mantilla 022', 0, 'accessory', 3);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0021'), NULL, 'Regalo para accesorios', -300000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0022', last_insert_rowid(), u.id, 'paid',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0022'), NULL, 'melissa', 1750000, 'dress', 0);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0023', last_insert_rowid(), u.id, 'paid',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0023'), NULL, 'noeline', 2870000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0023'), 14, 'mantilla 041', 0, 'accessory', 1);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0024', last_insert_rowid(), u.id, 'paid',
         '2026-02-23', 'Histórico (importado)', 1610000, 0, 1610000, 1,
         'pagos.xlsx · feb 26 · fila 21'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0024'), NULL, 'p107', 1610000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0024'), NULL, 't6cad0 66', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0024'), NULL, 'mantilla 41', 0, 'accessory', 2);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0025', last_insert_rowid(), u.id, 'active',
         '2026-02-24', 'Histórico (importado)', 2490000, 150000, 2340000, 1,
         'pagos.xlsx · feb 26 · fila 22'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0025'), NULL, 'P39', 2490000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0025'), NULL, 'mantilla 45', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0026', last_insert_rowid(), u.id, 'paid',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0026'), NULL, 'ella', 1750000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0026'), NULL, 'Regalo para accesorios', -150000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0027', last_insert_rowid(), u.id, 'paid',
         '2026-02-28', 'Histórico (importado)', 2800000, 300000, 2500000, 1,
         'pagos.xlsx · feb 26 · fila 24'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0027'), NULL, 'adelina', 2800000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0027'), NULL, 'tiara 58', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0027'), NULL, 'cinto 17', 0, 'accessory', 2);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0027'), NULL, 'Regalo para accesorios', -300000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0028', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0028'), NULL, 'p46 liquidacion', 1100000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0028'), NULL, 'crinolina 3 aros', 0, 'accessory', 1);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0029', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0029'), NULL, 'jazmin', 3950000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0029'), NULL, 'Regalo para accesorios', -300000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0030', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0030'), NULL, 'p24 liquidacion capa', 500000, 'dress', 0);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0031', last_insert_rowid(), u.id, 'active',
         '2026-05-23', 'Histórico (importado)', 4200000, 300000, 3900000, 1,
         'pagos.xlsx · 6 mayo 26 · fila 5'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0031'), NULL, 'intima', 4200000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0031'), NULL, 'Regalo para accesorios', -300000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0032', last_insert_rowid(), u.id, 'paid',
         '2026-05-30', 'Histórico (importado)', 1900000, 150000, 1750000, 1,
         'pagos.xlsx · 6 mayo 26 · fila 6'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0032'), NULL, 'p57 mantilla 49', 1900000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0032'), NULL, 'Regalo para accesorios', -150000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0033', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0033'), NULL, 'j1191', 3150000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0033'), NULL, 'Regalo para accesorios', -250000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0034', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0034'), NULL, 'p56', 2150000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0035', last_insert_rowid(), u.id, 'active',
         '2026-05-30', 'Histórico (importado)', 2000000, 150000, 1850000, 1,
         'pagos.xlsx · 6 mayo 26 · fila 9'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0035'), 1, 'p139 mantilla 039', 2000000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0035'), NULL, 'Regalo para accesorios', -150000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0036', last_insert_rowid(), u.id, 'paid',
         '2026-04-06', 'Histórico (importado)', 2580000, 0, 2580000, 1,
         'pagos.xlsx · abril 26 · fila 2'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0036'), NULL, 'j1170 muetra tIrantes', 2580000, 'dress', 0);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0037', last_insert_rowid(), u.id, 'active',
         '2026-04-16', 'Histórico (importado)', 2550000, 0, 2550000, 1,
         'pagos.xlsx · abril 26 · fila 3'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0037'), NULL, 'melissa', 2550000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0037'), 13, 'mantilla 039', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0037'), NULL, 'mantilla 48', 0, 'accessory', 2);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0037'), NULL, 'tiara 63', 0, 'accessory', 3);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0038', last_insert_rowid(), u.id, 'paid',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0038'), NULL, 'p59', 2140000, 'dress', 0);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0039', last_insert_rowid(), u.id, 'paid',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0039'), 1, 'p139', 1500000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0040', last_insert_rowid(), u.id, 'paid',
         '2026-04-25', 'Histórico (importado)', 1675000, 150000, 1525000, 1,
         'pagos.xlsx · abril 26 · fila 6'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0040'), 1, 'p139', 1675000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0040'), NULL, 'crinolina 6 aros', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0040'), NULL, 'Regalo para accesorios', -150000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0041', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0041'), NULL, 'mikado moño velo largo de perlas velo corto de perlas', 3160000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0041'), NULL, 'Regalo para accesorios', -250000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0042', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0042'), 1, 'p139 velo largo liso', 1860000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0043', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0043'), 1, 'p139', 1650000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0043'), NULL, 'Regalo para accesorios', -150000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0044', last_insert_rowid(), u.id, 'active',
         '2026-06-20', 'Histórico (importado)', 815000, 0, 815000, 1,
         'pagos.xlsx · junio 26 · fila 7'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0044'), 4, 's14 m', 815000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0044'), NULL, 'tirantes', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0044'), NULL, 'crinolina 1 aro', 0, 'accessory', 2);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0045', last_insert_rowid(), u.id, 'paid',
         '2026-07-18', 'Histórico (importado)', 1830000, 0, 1830000, 1,
         'pagos.xlsx · jul26 · fila 2'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0045'), NULL, 'crinolina 3 aros tiara 66', 1830000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0045'), NULL, 'melissa', 0, 'accessory', 1);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0046', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0046'), NULL, 'mantilla 45', 3650000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0046'), NULL, 'j1194', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0046'), NULL, 'Regalo para accesorios', -300000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0047', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0047'), NULL, 'crinolina 6 a', 2150000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0047'), NULL, 'cherry', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0047'), NULL, 'Regalo para accesorios', -150000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0048', last_insert_rowid(), u.id, 'active',
         '2026-07-29', 'Histórico (importado)', 1700000, 100000, 1600000, 1,
         'pagos.xlsx · jul26 · fila 6'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0048'), NULL, 'crinolina 3 a', 1700000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0048'), NULL, 'ella', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0048'), NULL, 'Regalo para accesorios', -100000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0049', last_insert_rowid(), u.id, 'paid',
         '2026-08-01', 'Histórico (importado)', 240000, 0, 240000, 1,
         'pagos.xlsx · ago 26 · fila 2'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0049'), NULL, 'titiara63', 240000, 'dress', 0);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0050', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0050'), NULL, 'mantilla o39', 2800000, 'dress', 0);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0050'), 10, 'madelyn', 0, 'accessory', 1);
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0050'), NULL, 'Regalo para accesorios', -150000, 'gift_credit', 99);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
  ...
  SELECT 'mty', 'MTY-IMP-0051', last_insert_rowid(), u.id, 'active',
    ...
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0051'), NULL, 'amaranta', 3000000, 'dress', 0);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
...
INSERT INTO contracts (store_id, folio, customer_id, seller_id, status, signed_at, plan_name,
                       list_total_cents, gift_credit_cents, total_cents, imported, import_source)
  SELECT 'mty', 'MTY-IMP-0052', last_insert_rowid(), u.id, 'active',
         '2026-09-02', 'Histórico (importado)', 2350000, 0, 2350000, 1,
         'pagos.xlsx · Hoja7 · fila 2'
    FROM users u WHERE u.store_id = 'mty' AND u.role = 'owner' ORDER BY u.id LIMIT 1;
INSERT INTO contract_items (contract_id, item_id, description, price_cents, line_kind, sort)
  VALUES ((SELECT id FROM contracts WHERE folio = 'MTY-IMP-0052'), NULL, 'cherry mantilla 039', 2350000, 'dress', 0);
INSERT INTO payments (contract_id, store_id, paid_at, paid_at_raw, amount_cents, method, collected_by, imported)
  SELECT c.id, 'mty', '2026-09-02', 'anticipo', 300000, 'cash', c.seller_id, 1
    FROM contracts c WHERE c.folio = 'MTY-IMP-0052';
